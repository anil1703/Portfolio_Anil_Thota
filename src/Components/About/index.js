...
const About = () => {
    return (
        ...
        <div id="about" className="about">
            ...
            <img alt="about_banner" className="aboutme-img" src="https://res.cloudinary.com/dafmi9027/image/upload/v1720004055/Portfolio%20Update/Pngtree_children_s_software_programming_5401259_g6hv6o.png"/>
